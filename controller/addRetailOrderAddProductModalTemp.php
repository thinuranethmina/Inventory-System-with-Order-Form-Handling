    ...
    <div class="row">
        ...
        <div class="modal--body">
            <div class="row p-3 text-center">
                <div class="col-12">
                    ...
                    <div class="row my-3">
                        <div class="col-12">
                            <select onchange="updateAddRetailOrderProductViewer();" id="product" class="form-control">
                    ...
                    <div class="my-3 d-flex">
                        <div class="">
                            <input type="text" class="form-control" onkeydown="keyBlocker(event,'qty');" id="qty" placeholder="Buying Qty" />
                        </div>
                        <div class="px-3 my-auto fs-5">+</div>
                        <div class="">
                            <input type="text" class="form-control" onkeydown="keyBlocker(event,'qty');" id="fqty" placeholder="Free qty" />
                        </div>
                    </div>
                    ...
                    <div class="my-3 d-flex">
                        <div class="">
                            <input type="text" class="form-control" onkeydown="keyBlocker(event,'qty');" id="pqty" placeholder="Qty from primary stock" />
                        </div>
                        <div class="px-3 my-auto fs-5">+</div>
                        <div class="">
                            <input type="text" class="form-control" onkeydown="keyBlocker(event,'qty');" id="oqty" placeholder="Qty from ongoing stock" />
                        </div>
                    </div>
        ...
        <div class="modal--footer d-sm-flex text-secondary">
            <div class="ml-auto float-right p-2">
                ...
                <button class="btn submit-btn" onclick="addProducttoRetailInvoice();">Add</button>
            </div>
        </div>
    </div>
<?php
