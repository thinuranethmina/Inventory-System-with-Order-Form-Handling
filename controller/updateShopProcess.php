        ...
        if ($isReady) {
            ...
            if ($resultset1->num_rows == 0) {
                ...
                if (!empty(trim($_POST['omobile'])) && !empty(trim($_POST['mobile']))) {
                    $resultset2 = Database::search("SELECT * FROM `shop` WHERE (`mobile` = ? OR `other_mobile` = ? OR `mobile` = ? OR `other_mobile` = ?)  AND `id` != ? ", "sss", [$_POST['mobile'], $_POST['omobile'], $_POST['omobile'], $_POST['mobile'], $_POST['id']]);
