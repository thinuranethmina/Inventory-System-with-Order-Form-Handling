            ...
            <div class="row">
                ...
                <div class="modal--body">
                    <div class="row p-3 text-center">
                        <div class="col-12">
                            ...
                            <div class="row my-3">
                                <div class="col-12">
                                    <input type="text" onkeyup="balanceUpdateInAdditionalAmount(<?= $invoice['id'] ?>); formatPrice(this);" onkeydown="keyBlocker(event,'price');" class="form-control" id="additionalAmount" placeholder="Additional Amount" />
                                </div>
                            </div>
                ...
                <div class="modal--footer d-sm-flex text-secondary">
                    <div class="ml-auto float-right p-2">
                        ...
                        <button class="btn submit-btn" onclick="addOrderAdditionalAmount(<?= $_POST['id'] ?>);">Add</button>
                    </div>
                </div>
            </div>
<?php
