                            ...
                            <tr style="height: 8px !important;">
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" onkeydown="keyBlocker(event,'qty');" class="form-control p-0 px-1 m-0" style="height: min-content !important;" id="discount" onkeyup="updateOrderSummeryPaymentsInEdit(); " placeholder="0">
