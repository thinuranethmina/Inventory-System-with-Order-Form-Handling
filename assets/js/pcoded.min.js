...
function horizontalmobilemenuclick() {
    $(window)[0].innerWidth;
    $(".pc-navbar li").off("click"), $(".pc-navbar > li:not(.pc-caption)").on("click", function() { $(this).children(".pc-submenu").removeAttr("style"), $(this).hasClass("pc-trigger") ? $(this).removeClass("pc-trigger") : ($("li.pc-trigger").removeClass("pc-trigger"), $(this).addClass("pc-trigger")) }), $(".pc-navbar > li:not(.pc-caption) li").on("click", function(e) { e.stopPropagation(), $(this).hasClass("pc-trigger") ? $(this).removeClass("pc-trigger") : ($(this).parent(".pc-submenu").find("li.pc-trigger").removeClass("pc-trigger"), $(this).addClass("pc-trigger")) })
}

function addscroller() { if (rmmini(), menuclick(), $(".navbar-content")[0]) { new PerfectScrollbar(".navbar-content", { wheelSpeed: .5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40 }) } }

function menuclick() {
    $(window)[0].innerWidth;
    $(".pc-navbar li").off("click"), $("body").hasClass("minimenu") || ($(".pc-navbar li:not(.pc-trigger) .pc-submenu").slideUp(), $(".pc-navbar > li:not(.pc-caption)").on("click", function() { $(this).hasClass("pc-trigger") ? ($(this).removeClass("pc-trigger"), $(this).children(".pc-submenu").slideUp("fast")) : ($("li.pc-trigger").children(".pc-submenu").slideUp("fast"), $("li.pc-trigger").removeClass("pc-trigger"), $(this).addClass("pc-trigger"), $(this).children(".pc-submenu").slideDown("fast")) }), $(".pc-navbar > li:not(.pc-caption) li").on("click", function(e) { e.stopPropagation(), $(this).hasClass("pc-trigger") ? ($(this).removeClass("pc-trigger"), $(this).children(".pc-submenu").slideUp("fast")) : ($(this).parent(".pc-submenu").find("li.pc-trigger").children(".pc-submenu").slideUp("fast"), $(this).parent(".pc-submenu").find("li.pc-trigger").removeClass("pc-trigger"), $(this).addClass("pc-trigger"), $(this).children(".pc-submenu").slideDown("fast")) }))
}

function rmdrp() { $(".pc-header:not(.pc-mob-header) .pc-mob-drp").removeClass("mob-drp-active"), $(".pc-header:not(.pc-mob-header) .pc-md-overlay").remove() }

function rmthead() { $(".pc-header:not(.pc-mob-header)").removeClass("mob-header-active"), $(".pc-header:not(.pc-mob-header) .pc-md-overlay").remove() }

function rmmenu() { $(".pc-sidebar").removeClass("mob-sidebar-active"), $(".topbar").removeClass("mob-sidebar-active"), $(".pc-sidebar .pc-menu-overlay").remove(), $(".topbar .pc-menu-overlay").remove() }

function rmovermenu() { $(".pc-sidebar").removeClass("pc-over-menu-active"), $(".topbar").removeClass("mob-sidebar-active"), $(".pc-sidebar .pc-menu-overlay").remove(), $(".topbar .pc-menu-overlay").remove() }

function rmactive() { $(".pc-sidebar .pc-navbar li").removeClass("active"), $(".pc-sidebar .pc-navbar li").removeClass("pc-trigger"), $(".topbar .dropdown").removeClass("show"), $(".topbar .dropdown-menu").removeClass("show"), $(".pc-sidebar .pc-menu-overlay").remove(), $(".topbar .pc-menu-overlay").remove() }
