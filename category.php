            ...
            <div class="page-header">
                ...
                <div class="row px-2 px-md-4">
                    <div class="col-12 mb-3 px-2 d-flex justify-content-between">
                        <h1 class="text-white my-auto">Categories</h1>
                        <button class="btn btn-light width-fit-content my-auto" onclick="addCategoryModalOpen();">Add New Category</button>
                    </div>
                    ...
                    <?php
                    $category_rs = Database::search("SELECT * FROM `category` ORDER BY  `category`.`date_time` DESC ");
                    ?>

                    <div class="col-12">
                        <span class="text-white f-w-300">Showing <?= $category_rs->num_rows ?> entries</span>
                    </div>
                    <div class="col-12 col-md-8 col-lg-7 col-xl-5 mx-auto px-2" id="resultContent">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" text-center">
                                            <img class="action-icon" onclick="editCategoryModalOpen(<?= $category['id'] ?>);" src="assets/images/icons/edit.png">
                                        </td>
                                    </tr>
