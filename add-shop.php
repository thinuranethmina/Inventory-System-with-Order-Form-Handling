            ...
            <div class="pcoded-content">
                ...
                <div class="row px-2 px-md-4 ">
                    <div class="col-12">
                        ...
                        <h1 class="mb-5 text-white">Add New Shop</h1>
                                ...
                                <div class="card-border p-3 p-md-5 rounded rounded-5">
                                    ...
                                    <div class="row my-3">
                                        <div class="col-12 col-lg-3 my-auto">
                                            <span class="form-text-1">Shop Name</span>
                                        </div>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-12 col-lg-9">
                                            <input type="text" id="mobile" class="form-control" placeholder="Enter Primary Mobile Here">
                                        </div>
                                    </div>

                                    <div class="row my-3">
                                        <div class="col-12 col-lg-3 my-auto">
                                            <span class="form-text-1">Other Phone</span>
                                        </div>
                                        <div class="col-12 col-lg-9">
                                            <input type="text" id="omobile" class="form-control" placeholder="Enter Other Mobile Here">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-12 col-lg-9">
                                            <input type="text" id="address" class="form-control" placeholder="Enter Address Here">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 col-lg-9">
                                            <div class="col-12 col-lg-9">
                                                ...
                                                <label for="imgchooser0" style="cursor: pointer;">
                                                    <img class="mx-1 p-2" id="image0" src="assets/images/icons/addShop.png" style="min-width: 100px; max-width: 180px; height: auto; border-radius: 5px;" onmouseover="this.style.backgroundColor='#FFE9D7';" onmouseout="this.style.backgroundColor='white';" />
                                                </label>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-12 col-lg-9">
                                            <input type="text" id="location" placeholder="latitude, longitude" value="6.81054437367081, 79.99660427484544" class="form-control" onkeyup="updateLocation();">
                                        </div>
                                        <div class="col-12">
                                            <div id="gmap" style="width: 100%; height: 400px;" class="mt-3">
                                                <iframe src="https://maps.google.com/maps?q=6.81054437367081, 79.99660427484544&amp;z=15&amp;output=embed" style="width: 100%; height: 400px; border: 1px solid rgb(178, 178, 178); z-index: 0;" class="rounded rounded-3"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-12">
                                            <button class="btn submit-btn w-100" onclick="addShop(this);">Submit</button>
                                        </div>
                                    </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if ('geolocation' in navigator) {
                    navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        Swal.fire(
                            'Support',
                            'You can select your live location on map when you turn on location and reload this page.',
                            'question'
                        )
                    });
                } else {
